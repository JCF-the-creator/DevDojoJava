...
public class DateTimeFomaterTest01 {
    public static void main(String[] args) {
        //Format transforma do objeto para uma String
        //Parse transforma da String em um Objato
        ...
        System.out.println();
        LocalDate parse1 = LocalDate.parse("20210219", DateTimeFormatter.BASIC_ISO_DATE); // se o texto está formatado no padrão ISO o java não sabe do padrão utilizado até você informar pelo DateTimeFormater o padrão da String
